...
os.environ["GOOGLE_API_KEY"] = "AIzaSyBB0mZ-Ca38pyXb3VvH6kuTA83OcHtvouw"
...
def voice_assistance(user_input):
    ...
    prompt = f"""
    You are my friend in an engaging conversation with a user. The user just asked the following question:
    '{user_input}'
